...
<html lang="en">
  ...
  <body id="page-top">
    ...
    ?>
      <script>
          swal("Konfirmasi Berhasil", "Klik ok untuk menutup", "success")
      </script>
    <?php
            ...
            <div class="card-body">
              <div class="table-responsive">
                <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                  ...
                  <tbody>
                    <?php
                      $get_data = "SELECT * FROM tb_gadai g JOIN tb_detailgadai dg on g.kode_gadai = dg.kode_gadai WHERE dg.status_konfirmasi = 1";
                      ...
                      ?>
                        <tr>
                          ...
                          <td><a href="detail_konfir.php?kode=<?php echo $dt['kode_gadai'] ?>&bulan=<?php echo $dt['bulan'] ?>">Detail</a></td>
                        </tr>
                      <?php
                        $no++;
                        }
